      ...
      <footer class="main-footer fl-wrap">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="subscribe-header">
                  ...
                  <p>
                    Whant to be notified about new locations ? Just sign up.
                  </p>
                </div>
              </div>
              <div class="col-md-7">
            ...
            <div class="row">
                      ...
                      <li class="clearfix">
                        ...
                        <div class="widget-posts-descr">
                          ...
                          <span class="widget-posts-date">
                            <i class="fal fa-calendar"></i> 21 Mar 09.05{" "}
                          </span>
                        </div>
                      </li>
                      <li class="clearfix">
                        ...
                        <div class="widget-posts-descr">
                          ...
                          <span class="widget-posts-date">
                            <i class="fal fa-calendar"></i> 7 Mar 18.21{" "}
                          </span>
                        </div>
                      </li>
                      <li class="clearfix">
                        ...
                        <div class="widget-posts-descr">
                          ...
                          <span class="widget-posts-date">
                            <i class="fal fa-calendar"></i> 7 Mar 16.42{" "}
                          </span>
                        </div>
                      </li>
                    </ul>
              ...
              <div class="col-md-4">
                <div class="footer-widget fl-wrap ">
                  <h3>Our Twitter</h3>
                  <div
                    class="twitter-holder fl-wrap scrollbar-inner2"
                    data-simplebar
        ...
        <div class="sub-footer  fl-wrap">
          <div class="container">
            <div class="copyright">
              {" "}
              &#169; Townhub 2019 . All rights reserved.
            </div>
            <div class="lang-wrap">
              <div class="show-lang">
                <span>
