...
function initTowhub() {
  ...
  $('input[name="datepicker-here-time"]').on("cancel.daterangepicker", function(
    ev,
    picker
  ) {
    $(this).val("");
  ...
  $(".close_gcc").on("click", function() {
    $(this)
      .parent(".geodir-category_contacts")
      .removeClass("visgdcc");
  });
  // Header ------------------
  ...
  function showWishlist() {
    wlwrp
      .fadeIn(1)
      .addClass("vis-wishlist")
      .removeClass("novis_wishlist");
    hideSearch();
  ...
  function hideWishlist() {
    wlwrp
      .fadeOut(1)
      .removeClass("vis-wishlist")
      .addClass("novis_wishlist");
  ...
  $(".show-hidden-map").on("click", function(e) {
    ...
    $(".show-hidden-map")
      .find("span")
      .text(
        $(".show-hidden-map span").text() === "Close" ? "On The Map" : "Close"
      );
  ...
  $(".fixed-listing-header").scrollToFixed({
    ...
    limit: function() {
      var a =
        $(".limit-box").offset().top - $(".fixed-listing-header").outerHeight();
      return a;
    }
  });
...
function cardRaining2() {
  ...
  cr2.each(function(cr) {
    ...
    $("<i class='fas fa-star'></i>")
      .duplicate(starcount2)
      .prependTo(this);
  });
  sts.each(function(sts) {
    var pricecount = $(this).attr("data-pricerating");
    $("<strong>$</strong>")
      .duplicate(pricecount)
      .prependTo(this);
  });
